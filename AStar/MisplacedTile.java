...
public class MisplacedTile {
	...
	MisplacedTile(String intial, String finalGoal)
	{
	...
	public void search()
	{
		...
		System.out.println("Misplaced tile A* search!");
		...
		while(!frontier.isEmpty())
		{
			try{
				...
				// Arranging the List in terms of Misplaced Tiles for each State
				String temp = null;
				...
				// ends to determine which child to expand
				if(temp != null)
					frontier.addFirst(temp);
